...
//  iOSTemplate
//
//  Created by Denny Mathew on 04/08/17.
...
public class KeychainService: NSObject {
    ...
    public class func deletePassword(service: NSString) {
    ...
    public class func savePassword(service: NSString, data: NSString) {
    ...
    public class func loadPassword(service: NSString) -> NSString? {
        // Instantiate a new default keychain query
